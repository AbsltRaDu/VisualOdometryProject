...
test_sampler = ProgressiveWindowBatchSampler(dataset_test, batch_size=8, window_size=WINDOW_SIZE, shuffle=True)
...
if os.path.isfile('process_of_fitting/fitting_models/CNNResNet50_VO_SW_TEST.tar'):
    state_dict_cnn = torch.load('process_of_fitting/fitting_models/CNNResNet50_VO_SW_TEST.tar', map_location='cpu')
