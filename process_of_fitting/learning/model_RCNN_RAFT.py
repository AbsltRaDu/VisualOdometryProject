...
model = DeepVO_RAFT(encoder=encoder, feat_dim=128, hidden_size=256, dropout=0.3)
model = model.to(device)

if os.path.isfile('process_of_fitting/fitting_models/RCNN_RAFT.tar'):
    state_dict_cnn = torch.load('process_of_fitting/fitting_models/RCNN_RAFT.tar', map_location=device)
