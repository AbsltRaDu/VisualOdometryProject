...
from models.modelsNN.CNN_RAFT import RAFTPoseCNN
...
dataset_train = mavDataset('datasets/simulation', transform, normalize=normalize, device='cpu', lst_of_datasets=lst_of_dataset_train) # Сразу формируем все массивы на GPU
