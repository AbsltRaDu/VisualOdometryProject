...
dct_of_results = training(train_data, test_data, model, loss_func, optimizer, epochs, device=device, name_of_model=os.path.join('process_of_fitting/fitting_models', 'CNNResNet50_VO_2_0.tar'), squueze=False)
