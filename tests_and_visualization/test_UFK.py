...
lst_of_dataset_test = ['mav0_easy1']
...
modelVO = LKOpticalFlowVO(width=752, height=480, new_width=752, new_height=480, fov_deg=90, baseline=0.6, return_debug=False, max_depth=500, min_depth=0.1)
...
simulation = SimulationUFK(UKF=ukf, model=modelVO, device='cpu', dtrain=dtrain, norm=normalize, debug=False, 
                           path_file_of_result='tests_and_visualization/results_of_models/UFK1.json', gps_window=0, win_size=100)
simulation()
